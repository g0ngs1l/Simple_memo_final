...
class ListItem extends StatelessWidget {
  const ListItem({
    super.key,
    required this.lstMemoInfo,
    required this.index,
  });

  final List<MemoInfo> lstMemoInfo;
  final int index;
          ...
          Padding(
            ...
            child: Align(
              ...
              child: RatingBar.builder(
                initialRating: lstMemoInfo[index].importance.toDouble(),
                minRating: 1,
